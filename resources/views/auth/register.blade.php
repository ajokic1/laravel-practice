    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-jet-input class="block mt-1 w-full" type="text" name="company" :value="old('company')" required autofocus autocomplete="company" />
            </div>

            <div>
                <x-jet-label value="{{ __('Country') }}" />
                <select class="block mt-1 w-full form-input rounded-md shadow-sm" name="country" :value="old('country')" required autofocus autocomplete="country" >
